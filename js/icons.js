...
const P = {
  ...
  cog:      '<circle cx="12" cy="12" r="3.1"/><path d="M12 2.4a1.4 1.4 0 0 1 1.4 1.4v.5c0 .5.3 1 .8 1.2s1 .2 1.4-.2l.4-.3a1.4 1.4 0 0 1 2 2l-.3.4c-.4.4-.5.9-.2 1.4s.7.8 1.2.8h.5a1.4 1.4 0 0 1 0 2.8h-.5c-.5 0-1 .3-1.2.8s-.2 1 .2 1.4l.3.4a1.4 1.4 0 0 1-2 2l-.4-.3c-.4-.4-.9-.5-1.4-.2s-.8.7-.8 1.2v.5a1.4 1.4 0 0 1-2.8 0v-.5c0-.5-.3-1-.8-1.2s-1-.2-1.4.2l-.4.3a1.4 1.4 0 0 1-2-2l.3-.4c.4-.4.5-.9.2-1.4s-.7-.8-1.2-.8h-.5a1.4 1.4 0 0 1 0-2.8h.5c.5 0 1-.3 1.2-.8s.2-1-.2-1.4l-.3-.4a1.4 1.4 0 0 1 2-2l.4.3c.4.4.9.5 1.4.2s.8-.7.8-1.2v-.5A1.4 1.4 0 0 1 12 2.4Z"/>',
